...
<template>
    ...
    <UserFashionLayout :cart-count="cartCount" :total-orders="stats.total_orders" :pending-orders="stats.pending_orders"
        ...
        <section class="welcome-banner">
            <div class="welcome-content">
                ...
                <div class="welcome-actions">
                    <Link href="/client/shop" class="primary-button">
                        <AppstoreOutlined />
                        Continue Shopping
                        <ArrowRightOutlined />
                    </Link>

                    <Link href="/client/orders" class="secondary-button">
                        View My Orders
                    </Link>
                </div>
            </div>
        ...
        <section class="stats-grid">
            ...
            <Link href="/client/orders" class="stat-card">
            ...
            <Link href="/client/orders/pending" class="stat-card">
            ...
            <Link href="/client/orders/completed" class="stat-card">
        ...
        <section class="dashboard-grid">
            ...
            <div class="dashboard-card orders-card">
                ...
                <div class="card-header">
                    ...
                    <Link href="/client/orders" class="view-all-link">
                        View All
                        <ArrowRightOutlined />
                    </Link>
                </div>
                ...
                <div v-if="recentOrders.length" class="orders-list">
                    <Link v-for="order in recentOrders" :key="order.id" :href="`/client/orders/${order.id}`"
                        class="order-row">
                ...
                <div v-else class="empty-state">
                    ...
                    <Link href="/client/shop" class="empty-button">
                        Start Shopping
                        <ArrowRightOutlined />
                    </Link>
                </div>
            ...
            <div class="dashboard-card cart-dashboard-card">
                ...
                <Link href="/client/cart" class="cart-button">
                    View Shopping Cart
                    <ArrowRightOutlined />
                </Link>

                <Link href="/client/shop" class="continue-shopping">
                    Continue Shopping
                    <ArrowRightOutlined />
                </Link>
            </div>
        ...
        <section class="quick-section">
            ...
            <div class="quick-grid">
                ...
                <Link href="/client/shop" class="quick-card">
                ...
                <Link href="/client/orders" class="quick-card">
                    <div class="quick-icon">
                        <ShoppingOutlined />
                    </div>
                ...
                <Link href="/client/payments" class="quick-card">
                    <div class="quick-icon">
                        <WalletOutlined />
                    </div>
                ...
                <Link href="/client/profile" class="quick-card">
                    <div class="quick-icon">
                        <InboxOutlined />
                    </div>
...
.dashboard-grid {
    ...
    grid-template-columns:
        minmax(0, 1.65fr) minmax(300px, 0.8fr);
